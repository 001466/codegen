...
/**
 * ���� �����rs���󹹽�columnmodel����SQL2008ʵ���ࡣ
 * @author codash
 *
 */
public class Sql2008MapCmd implements MapCmd<ColumnModel> {
	...
	private String getJavaType(String dbtype,int precision,int scale)
	{
		...
		if(dbtype.equals("char") || dbtype.endsWith("text") || dbtype.equals("xml") || dbtype.equals("varchar"))
			return "String";
