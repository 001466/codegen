...
public class ConfigModel {
	Log log=LogFactory.getLog(ConfigModel.class);  
	...
	public class Database {
		 ...
		 * 数据库实现类。<br>
		 * 目前可为三种：
		 * Oracle ：com.codash.cgm.db.impl.OracleHelper
		 * MySql：com.codash.cgm.db.impl.MySqlHelper
		 *	Sql2005：com.codash.cgm.db.impl.Sql2005Helper
		 * @return
		 */
	...
	public class Files{
		...
		public void addFile(String template,String fileName,String dir,boolean append,String insertTag,String startTag,String endTag)
		{
			File file=new File(template, fileName, dir,append,insertTag,startTag,endTag);
			this.files.add(file);
		}
		...
		public class File {
			...
			public File(String template, String filename, String dir,boolean append,String insertTag,String startTag,String endTag) {
				this.template = template;
	...
	public class Table {
		...
		private Map<String, String> subtable = new HashMap<String, String>();
		 ...
		 * @return
		 */
		public Map<String, String> getSubtable() {
			return subtable;
		}

		public void setSubtable(Map<String, String> subtable) {
