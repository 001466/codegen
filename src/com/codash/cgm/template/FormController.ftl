...
public class ${class}FormController extends BaseFormController
{
	...
	public void save(HttpServletRequest request, HttpServletResponse response, ${class} ${classVar},BindingResult bindResult) throws Exception
	{
		
		ResultMessage resultMessage=validForm("${classVar}", ${classVar}, bindResult, request);
